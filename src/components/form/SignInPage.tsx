        ...
        <div className=" shadow-2xl  bg-white rounded-2xl  w-[500px] h-[450px] p-5">
          ...
          <div className="flex justify-around mt-[30px]">
            <button
              ...
              className=" text-center font-sans  font-bold btn-primary p-3 rounded-md  w-[120px]"
            >
              Назад
            </button>
            <button
              type="submit"
              className="text-center font-sans  font-bold btn-primary  p-2 rounded-md w-[120px] "
            >
              Войти
            </button>
          </div>
